...
def parsing(args: list=None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description=('Calculate FoldX energies for'
                            ' the variants pickle file.'))
...
if __name__ == '__main__':
    ...
    # variants = pd.read_pickle(f'./variants_features/15_variants_{job}.pkl')
